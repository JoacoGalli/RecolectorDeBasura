...
TRIG = 19 #Variable que contiene el GPIO al cual conectamos la señal TRIG del sensor
...
direction_tras1 = 25
step_tras1 = 26
motor_traslacion=  motor.A4988Nema(direction_tras1, step_tras1, (-1, -1, -1),"A4988")
