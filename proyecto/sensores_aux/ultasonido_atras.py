...
TRIG = 14 #14 #16 7 #Variable que contiene el GPIO al cual conectamos la señal TRIG del sensor
ECHO = 15 #15 #18 24 #Variable que contiene el GPIO al cual conectamos la señal ECHO del sensor
sound_speed = 34300
