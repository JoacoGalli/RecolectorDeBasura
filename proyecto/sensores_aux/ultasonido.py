...
TRIG = 7 #14lejos #16 cerca 7 #Variable que contiene el GPIO al cual conectamos la señal TRIG del sensor
ECHO = 24 #15 #18 24 #Variable que contiene el GPIO al cual conectamos la señal ECHO del sensor
sound_speed = 34300
